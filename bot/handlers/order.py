...
@router.message(OrderProcedure.company_name)
...
@router.message(OrderProcedure.company_mail)
...
@router.message(OrderProcedure.order_name)
...
@router.message(OrderProcedure.order_price)
...
@router.message(OrderProcedure.order_description)
